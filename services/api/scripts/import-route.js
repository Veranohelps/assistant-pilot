...
const gpxDocument = new DOMParser().parseFromString(fs.readFileSync(from, 'utf8'));
...
const mainFeature = parsedDocument.features.find(feature => feature.geometry.type == "LineString");
...
const waypoints = [];
const pointFeatures = parsedDocument.features.filter(feature => feature.geometry.type == "Point");
